...
func easyjson7c82d03DecodeGoo(in *jlexer.Lexer, out *JobInfo) {
...
func easyjson7c82d03EncodeGoo(out *jwriter.Writer, in JobInfo) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v *JobInfo) UnmarshalJSON(data []byte) error {
	...
	easyjson7c82d03DecodeGoo(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *JobInfo) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7c82d03DecodeGoo(l, v)
}
func easyjson7c82d03DecodeGoo1(in *jlexer.Lexer, out *EmployeeStruct) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson7c82d03EncodeGoo1(out *jwriter.Writer, in EmployeeStruct) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v *EmployeeStruct) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson7c82d03DecodeGoo1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *EmployeeStruct) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7c82d03DecodeGoo1(l, v)
}
func easyjson7c82d03DecodeGoo2(in *jlexer.Lexer, out *BasicInfo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson7c82d03EncodeGoo2(out *jwriter.Writer, in BasicInfo) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v *BasicInfo) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson7c82d03DecodeGoo2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *BasicInfo) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7c82d03DecodeGoo2(l, v)
}
